...
const galleryPhotos: GalleryPhoto[] = [
  // facility-1
  {
    ...
    year: 2025,
    url: 'https://placehold.co/800x600?text=Galeria+DPS+Sloneczny+Dom+2025',
  ...
  },
  {
    ...
    facilityId: 'facility-1',
    year: 2024,
    url: 'https://placehold.co/800x600?text=Galeria+DPS+Sloneczny+Dom+2024',
  ...
  // facility-2
  {
    ...
    year: 2025,
    url: 'https://placehold.co/800x600?text=Galeria+DPS+Pod+Kasztanami+2025',
  ...
  },
  {
    ...
    facilityId: 'facility-2',
    year: 2024,
    url: 'https://placehold.co/800x600?text=Galeria+DPS+Pod+Kasztanami+2024',
  ...
  // facility-3
  {
    ...
    year: 2025,
    url: 'https://placehold.co/800x600?text=Galeria+DPS+Zielona+Przystań+2025',
  ...
  },
  {
    ...
    facilityId: 'facility-3',
    year: 2024,
    url: 'https://placehold.co/800x600?text=Galeria+DPS+Zielona+Przystań+2024',
  ...
  // facility-4
  {
    ...
    year: 2025,
    url: 'https://placehold.co/800x600?text=Galeria+DPS+Złota+Jesień+2025',
  ...
  },
  {
    ...
    facilityId: 'facility-4',
    year: 2024,
    url: 'https://placehold.co/800x600?text=Galeria+DPS+Złota+Jesień+2024',
...
export const letters: Letter[] = [
  // ---------- available (10) ----------
  {
    ...
    actionId: 'action-2025',
    turnId: 'turn-2025-1',
    imageUrls: ['https://placehold.co/400x600?text=List+001'],
    status: 'available',
    santaId: null,
    selectedAt: null,
    confirmedAt: null,
  ...
  },
  {
    ...
    actionId: 'action-2025',
    turnId: 'turn-2025-1',
    imageUrls: ['https://placehold.co/400x600?text=List+002'],
    status: 'available',
    santaId: null,
    selectedAt: null,
    confirmedAt: null,
  ...
  },
  {
    ...
    actionId: 'action-2025',
    turnId: 'turn-2025-2',
    imageUrls: ['https://placehold.co/400x600?text=List+003'],
    status: 'available',
    santaId: null,
    selectedAt: null,
    confirmedAt: null,
  ...
  },
  {
    ...
    actionId: 'action-2025',
    turnId: 'turn-2025-1',
    imageUrls: ['https://placehold.co/400x600?text=List+004'],
    status: 'available',
    santaId: null,
    selectedAt: null,
    confirmedAt: null,
  ...
  },
  {
    ...
    actionId: 'action-2025',
    turnId: 'turn-2025-2',
    imageUrls: ['https://placehold.co/400x600?text=List+005'],
    status: 'available',
    santaId: null,
    selectedAt: null,
    confirmedAt: null,
  ...
  },
  {
    ...
    actionId: 'action-2025',
    turnId: 'turn-2025-1',
    imageUrls: ['https://placehold.co/400x600?text=List+006'],
    status: 'available',
    santaId: null,
    selectedAt: null,
    confirmedAt: null,
  ...
  },
  {
    ...
    actionId: 'action-2025',
    turnId: 'turn-2025-2',
    imageUrls: ['https://placehold.co/400x600?text=List+007'],
    status: 'available',
    santaId: null,
    selectedAt: null,
    confirmedAt: null,
  ...
  },
  {
    ...
    turnId: 'turn-2025-3',
    imageUrls: [
      'https://placehold.co/400x600?text=List+008+str1',
      'https://placehold.co/400x600?text=List+008+str2',
    ],
    status: 'available',
    santaId: null,
    selectedAt: null,
  ...
  },
  {
    ...
    actionId: 'action-2025',
    turnId: 'turn-2025-3',
    imageUrls: ['https://placehold.co/400x600?text=List+009'],
    status: 'available',
    santaId: null,
    selectedAt: null,
    confirmedAt: null,
  ...
  },
  {
    ...
    actionId: 'action-2025',
    turnId: 'turn-2025-3',
    imageUrls: ['https://placehold.co/400x600?text=List+010'],
    status: 'available',
    santaId: null,
    selectedAt: null,
    confirmedAt: null,
  ...
  // ---------- selected (5) ----------
  {
    ...
    actionId: 'action-2025',
    turnId: 'turn-2025-1',
    imageUrls: ['https://placehold.co/400x600?text=List+011'],
    status: 'selected',
    santaId: 'santa-1',
  ...
  },
  {
    ...
    actionId: 'action-2025',
    turnId: 'turn-2025-1',
    imageUrls: ['https://placehold.co/400x600?text=List+012'],
    status: 'selected',
    santaId: 'santa-2',
  ...
  },
  {
    ...
    actionId: 'action-2025',
    turnId: 'turn-2025-2',
    imageUrls: ['https://placehold.co/400x600?text=List+013'],
    status: 'selected',
    santaId: 'santa-3',
  ...
  },
  {
    ...
    actionId: 'action-2025',
    turnId: 'turn-2025-2',
    imageUrls: ['https://placehold.co/400x600?text=List+014'],
    status: 'selected',
    santaId: 'santa-4',
  ...
  },
  {
    ...
    actionId: 'action-2025',
    turnId: 'turn-2025-3',
    imageUrls: ['https://placehold.co/400x600?text=List+015'],
    status: 'selected',
    santaId: 'santa-1',
  ...
  // ---------- confirmed (3) ----------
  {
    ...
    actionId: 'action-2025',
    turnId: 'turn-2025-1',
    imageUrls: ['https://placehold.co/400x600?text=List+016'],
    status: 'confirmed',
    santaId: 'santa-2',
  ...
  },
  {
    ...
    actionId: 'action-2025',
    turnId: 'turn-2025-1',
    imageUrls: ['https://placehold.co/400x600?text=List+017'],
    status: 'confirmed',
    santaId: 'santa-3',
  ...
  },
  {
    ...
    actionId: 'action-2025',
    turnId: 'turn-2025-2',
    imageUrls: ['https://placehold.co/400x600?text=List+018'],
    status: 'confirmed',
    santaId: 'santa-4',
  ...
  // ---------- returned (2) ----------
  {
    ...
    actionId: 'action-2025',
    turnId: 'turn-2025-1',
    imageUrls: ['https://placehold.co/400x600?text=List+019'],
    status: 'returned',
    santaId: null,
  ...
  // list archiwalny z akcji 2024 — powiązany z santa-5
  {
    ...
    actionId: 'action-2024',
    turnId: 'turn-2024-1',
    imageUrls: ['https://placehold.co/400x600?text=List+020+(2024)'],
    status: 'confirmed',
    santaId: 'santa-5',
